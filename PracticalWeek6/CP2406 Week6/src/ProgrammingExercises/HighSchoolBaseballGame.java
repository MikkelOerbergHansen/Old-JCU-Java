...
public class HighSchoolBaseballGame extends BaseballGame {
    ...
    private int[] team1Scores = new int[]{-1, -1, -1, -1, -1, -1, -1};
    private int[] team2Scores = new int[]{-1, -1, -1, -1, -1, -1, -1};

    public HighSchoolBaseballGame(String newTeam1, String newTeam2) {
    ...
    public void setTeamScores(String team, int inning, int score){
        ...
        boolean arrayStatus;
        if (inning -1 < 0 || inning -1 > 6){
            System.out.println("ERROR!!  inning is out of bounds - must be between 1 and 7");
            arrayStatus = false;
        }
    ...
    public String getTeamScores(String team, int inning){
        if (inning -1 < 0 || inning -1 > 6){
            return "ERROR!!  Inning is out of bounds - must be between 1 and 7";
        }
    ...
    public void GameResult(){
        ...
        if (team1Scores[6] > 0 && team2Scores[6] > 0){

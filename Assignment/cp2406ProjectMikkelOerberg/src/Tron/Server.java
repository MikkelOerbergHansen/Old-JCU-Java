package Assignment.cp2406ProjectMikkelOerberg.src.Tron;
...
public class Server {
        ...
        try
        {
            ...
            while(state == RUNNING) {
                ...
                if(alive_players <= 1) {
                    ...
                    FileOutputStream fos = new FileOutputStream(new File("Assignment/cp2406ProjectMikkelOerberg/src/leaderboard.txt"));
    ...
    public static void main(String[] args) {
        ...
        try{
            BufferedReader br = new BufferedReader(new FileReader("Assignment/cp2406ProjectMikkelOerberg/src/leaderboard.txt"));
